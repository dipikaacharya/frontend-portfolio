            ...
            <header className="sticky top-0 z-50 w-full border-b border-zinc-200 dark:border-zinc-800 bg-white/80 dark:bg-black/80 backdrop-blur-md">
                <div className="container mx-auto flex h-16 items-center justify-between px-4 md:px-6">
                    ...
                    <nav className="flex gap-4 sm:gap-6 items-center">
                        ...
                        <Link className="text-sm font-medium hover:underline underline-offset-4" href="/resumes">
                            Resumes
                        </Link>
                        <Link className="text-sm font-medium hover:underline underline-offset-4" href="/certificates">
                            Certificates
                        </Link>
                        ...
                        {user?.is_admin && (
                            <Link className="text-sm font-bold text-blue-600 dark:text-blue-400 hover:underline underline-offset-4" href="/admin">
                                Admin
                            </Link>
                        )}
                        {!isAuthenticated && (
                            <Link
                                href="/admin-login"
                                className="ml-2 inline-flex h-9 items-center justify-center rounded-md border border-zinc-200 bg-white px-3 text-[10px] font-medium uppercase tracking-wider text-zinc-500 shadow-sm transition-colors hover:bg-zinc-100 hover:text-zinc-900 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-zinc-950 dark:border-zinc-800 dark:bg-zinc-950 dark:hover:bg-zinc-800 dark:hover:text-zinc-50 dark:focus-visible:ring-zinc-300"
                            >
                                Admin Portal
                            </Link>
                        )}
